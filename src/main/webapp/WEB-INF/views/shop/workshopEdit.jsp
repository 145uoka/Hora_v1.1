...
<body>
  ...
  <form:form modelAttribute="form" method="POST" name="form" action="${pageContext.request.contextPath}/shop/workshopEdit/store" class="form-horizontal">
    ...
    <div class="container">
      ...
      <%-- メッセージ領域 --%>
      <div class="row">
        <div class="col-md-offset-1 col-md-10"><%@include file="/WEB-INF/fragment/messages.jspf"%></div>
      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group <ext:isErrors path='startDay' value='has-error'/> ">
                  <label class="col-md-5 control-label">適応開始日<span class="label label-danger" style="margin-left: 10px">必須</span></label>
                  <div class="col-md-3">
